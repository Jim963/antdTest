    ...
    <>
      <div className="fixed bottom-0 right-[35px] xl:right-[44px] h-[72px] xl:h-[80px] rounded-[12px_12px_0_0] bg-navyBlue">
        <div className="box-border h-full flex flex-row items-center justify-center p-[14px_28px] xl:p-[16px_20px]">
          <div className="text-[16px] xl:text-[18px] text-white ml-[9px] xl:ml-[20px] cursor-pointer">
            客戶取件
          </div>
          <div className="h-full border-0 border-r border-solid border-white mx-[24px] xl:mx-[40px]"></div>
          <div className="text-[16px] xl:text-[18px] text-white mr-[24px] xl:mr-[40px] cursor-pointer">
            店長收件
          </div>
